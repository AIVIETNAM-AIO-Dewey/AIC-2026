...
DAM_PROMPT = """Describe only the masked region in detail in English (at most 50 words). State the object or person, exact colors, visual attributes, appearance, surroundings, and visible action. Do not infer hidden facts."""
