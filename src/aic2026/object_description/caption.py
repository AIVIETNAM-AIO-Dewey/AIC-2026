...
DAM_PROMPT = """<image>
Describe only the masked region in one English sentence of at most 20 words.
State the visible object or person, attributes, and action. Do not infer hidden facts."""
