...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", "--output-root", dest="output_dir", type=Path, default=Path("/kaggle/working/multimodal_results"), help="Output directory")
    parser.add_argument("--max-frames", "--max-keyframes", dest="max_frames", type=int, default=5, help="Max frames to extract and test")
